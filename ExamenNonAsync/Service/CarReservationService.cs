...
using CTANDAI.CarReservationSystem.NonAsync.Repositories; // For repository interfaces
using CTANDAI.CarReservationSystem.NonAsync.Service;      // For ICarReservationService interface
